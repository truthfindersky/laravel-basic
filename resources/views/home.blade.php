                ...
                <div class="row">
                    <div class="col-lg-8 m-auto text-center col-sm-12 col-md-12">
                        <div class="banner-content content-padding">
                            <h5 class="subtitle">Laravel</h5>
                            <h1 class="banner-title">The PHP Framework For Web Artisans</h1>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-5  d-none d-lg-block col-sm-12">
                    <div class="intro-img">
                        <img src="{{ asset('images/banner/why-choose.png') }}" alt="intro-img" class="img-fluid">
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-sm-6 col-md-6">
                    <div class="service-box">
                        <div class="service-img-icon">
                            <img src="{{ asset('images/icon/007-digital-marketing-3.png') }}" alt="service-icon" class="img-fluid">
                        </div>
                ...
                <div class="col-lg-4 col-sm-6 col-md-6">
                    <div class="service-box ">
                        <div class="service-img-icon">
                            <img src="{{ asset('images/icon/008-digital-marketing-2.png') }}" alt="service-icon" class="img-fluid">
                        </div>
                        <div class="service-inner">
                ...
                <div class="col-lg-4 col-sm-6 col-md-6">
                    <div class="service-box">
                        <div class="service-img-icon">
                            <img src="{{ asset('images/icon/003-task.png') }}" alt="service-icon" class="img-fluid">
                        </div>
                        <div class="service-inner">
                ...
                <div class="col-lg-4 col-sm-6 col-md-6">
                    <div class="service-box">
                        <div class="service-img-icon">
                            <img src="{{ asset('images/icon/010-digital-marketing.png') }}" alt="service-icon" class="img-fluid">
                        </div>
                        <div class="service-inner">
                ...
                <div class="col-lg-4 col-sm-6 col-md-6">
                    <div class="service-box">
                        <div class="service-img-icon">
                            <img src="{{ asset('images/icon/006-analytics.png') }}" alt="service-icon" class="img-fluid">
                        </div>
                        <div class="service-inner">
                ...
                <div class="col-lg-4 col-sm-6 col-md-6">
                    <div class="service-box">
                        <div class="service-img-icon">
                            <img src="{{ asset('images/icon/004-hiring.png') }}" alt="service-icon" class="img-fluid">
                        </div>
                        <div class="service-inner">
                            <h4>Link Building </h4>
                                        ...
                                        <div class="testimonial-content style-2">
                                            <div class="author-info ">
                                                <div class="author-img">
                                                    <img src="{{ asset('images/author/3b.jpg') }}" alt="" class="img-fluid">
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-sm-12">
                                        <div class="testimonial-content style-2">
                                            <div class="author-info ">
                                                <div class="author-img">
                                                    <img src="{{ asset('images/author/5b.jpg') }}" alt="" class="img-fluid">
                                                </div>
                                            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-sm-6 col-md-3 text-center">
                <img src="{{ asset('images/clients/client01.png') }}" alt="partner" class="img-fluid">
            </div>
            <div class="col-lg-3 col-sm-6 col-md-3 text-center">
                <img src="{{ asset('images/clients/client06.png') }}" alt="partner" class="img-fluid">
            </div>
            <div class="col-lg-3 col-sm-6 col-md-3 text-center">
                 <img src="{{ asset('images/clients/client04.png') }}" alt="partner" class="img-fluid">
            </div>
            <div class="col-lg-3 col-sm-6 col-md-3 text-center">
                <img src="{{ asset('images/clients/client05.png') }}" alt="partner" class="img-fluid">
            </div>
        </div>
    </div>
</section>
